<nav x-data="{ open: false }" class="flex justify-center items-center bg-cinza-escuro pt-5 rounded-t-extra-lg border-none fixed bottom-0 left-0 w-full z-50border-gray-100">
